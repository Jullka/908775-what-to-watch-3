      ...
      <section className="movie-card movie-card--full">
        <div className="movie-card__header">
          <div className="movie-card__bg">
            <img src={this.props.film.background} alt={this.props.film.title} />
          </div>
            ...
            <nav className="breadcrumbs">
              <ul className="breadcrumbs__list">
                <li className="breadcrumbs__item">
                  <Link to={`/films/${this.props.film.id}`} className="breadcrumbs__link">{this.props.film.title}</Link>
                </li>
                <li className="breadcrumbs__item">
          ...
          <div className="movie-card__poster movie-card__poster--small">
            <img src={this.props.film.poster} alt={this.props.film.title} width="218" height="327" />
          </div>
        </div>
